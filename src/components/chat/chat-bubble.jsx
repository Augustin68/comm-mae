  ...
  return (
    <div className={`flex p-2 ${isUser &&!isTyping ? 'self-end' : 'self-start'} ${isTyping ? 'self-end' : null}`}>
        <div className={`flex flex-col gap-1`}>
            <div className={`border border-black rounded-tl-2xl h-full w-3 border-r-0 ${isTyping ? 'border-slate-400' : null}`}></div>
            <div className={
                `border border-black h-full w-3 border-r-0 
        ...
        <div className="flex flex-col gap-1">
            ...
            <div className={`border border-black h-full w-3 border-l-0
